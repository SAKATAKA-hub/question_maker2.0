    ...
    <main class="container">
        ...
        <section class="mt-3 mb-5"  style="max-width:600px; margin:0 auto;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">問題 1/3</h5>
                    <div class="card-text">
                        この昆虫の名前を選んでください。
                    </div>
                    <img src="{{ asset('storage/app/image/sample3.jpeg') }}" class="rounded w-100 mt-3" alt="question image">
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary">次の問題</button>
                          </div>
                    </div>
                </div>
            </div>
